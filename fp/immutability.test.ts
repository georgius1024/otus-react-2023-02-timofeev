...
import {
  OriginalTeam,
  ExpectedTeam,
  originalTeamToExpectedTeamFirst,
  originalArrayToExpectedArray,
  originalTeamToExpectedTeamLast,
} from "./immutability";
...
test("team to team", () => {
  ...
  expect(originalTeamToExpectedTeamFirst(originalTeam)).toEqual(expectedTeam);
});
...
test("team to team deep", () => {
  ...
  expect(originalTeamToExpectedTeamLast(originalTeam)).toEqual(expectedTeam);
});
